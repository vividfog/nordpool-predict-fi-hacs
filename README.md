...
| `sensor.nordpool_predict_fi_cheapest_custom_price_window` | Sensor | Lowest average across the configured custom window; attributes include window metadata alongside the hour mask. |
