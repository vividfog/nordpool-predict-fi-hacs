...
- Install Plotly Graph Card by @dbuezas via HACS (Frontend → Plotly Graph Card) for the calendar heatmap.
...
2) Open one of these files and copy its contents:
   ...
   - `npf_card_price_calendar_plotly.yaml` — Plotly heatmap calendar spanning realized and forecast price hours.
